...
_datasetFeaturesFiles_res = {"miniImagenet": "./checkpoints/miniImagenet/resnet12_S2M2_R/last/output.plk",
                             "CUB": "./checkpoints/CUB/resnet12_S2M2_R/last/output.plk",
                             "cifar": "./checkpoints/cifar/resnet12_S2M2_R/last/output.plk",
                             "tieredImagenet": "./checkpoints/tieredImagenet/resnet12_S2M2_R/last/output.plk",
                             "miniimagenet_train": "./checkpoints/miniimagenet/resnet12_S2M2_R/last/output_train.plk",
                             "CUB_train": "./checkpoints/CUB/resnet12_S2M2_R/last/output_train.plk",
                             "cifar_train": "./checkpoints/cifar/resnet12_S2M2_R/last/output_train.plk",
                             "tieredimagenet_train": "./checkpoints/tieredimagenet/resnet12_S2M2_R/last/output_train.plk",
...
def loadDataSet_res(dsname):
    if dsname not in _datasetFeaturesFiles_res:
    ...
    # home = expanduser("~")
    dataset = _load_pickle(_datasetFeaturesFiles_res[dsname])
